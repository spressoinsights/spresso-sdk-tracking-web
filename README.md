...
Please use the latest version **4.5.0-beta**. Click [here](SpressoSdk.html) for the full API reference. 
...
<script>
    (function (options) {
        ...
        s.async = true;
        s.src = 'https://spresso-sdk-tracking-web.us-east4.prod.spresso.com/v4.5.0-beta/spresso.sdk.tracking.web.js';
